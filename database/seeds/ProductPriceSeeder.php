...
class ProductPriceSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        $lines = [
            ...
            ['sku' => 'STOD1317', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '14.05'],
            ['sku' => 'STOD140', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '26.54'],
            ['sku' => 'STOD159', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '26.54'],
            ['sku' => 'STOD1643', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '14.05'],
            ['sku' => 'STOD1651', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '14.05'],
            ['sku' => 'STOD167', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '26.54'],
            ['sku' => 'STOD1678', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '14.05'],
            ...
            ['sku' => 'STOD2623', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '59.90'],
            ['sku' => 'STOD2631', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '89.00'],
            ['sku' => 'STOD2649', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '27.31'],
            ['sku' => 'STOD2658', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '27.31'],
            ['sku' => 'STOD2682', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '17.95'],
            ['sku' => 'STOD2712', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '27.31'],
            ...
            ['sku' => 'STOD2763', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '59.90'],
            ['sku' => 'STOD2771', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '59.90'],
            ...
            ['sku' => 'STOD2933', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '23.96'],
            ...
            ['sku' => 'STOD3009', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '24.97'],
            ['sku' => 'STOD3085', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '17.17'],
            ...
            ['sku' => 'STOD9999', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '21.90'],
            ['sku' => 'STOD9998', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '21.90'],
            ['sku' => 'STOD9997', 'table_id' => '1', 'start_date' => now()->format('Y-m-d'), 'price' => '21.90'],
        ];
