        ...
        <div class="row">
            <div class="col-3">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link active bg-second" id="v-pills-barcode-tab" data-toggle="pill" href="#v-pills-barcode" role="tab" aria-controls="v-pills-barcode" aria-selected="true">Boleto</a>
            ...
            <div class="col-9">
                <div class="tab-content pb-3" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-barcode" role="tabpanel" aria-labelledby="v-pills-barcode-tab">
                        <!-- <p class="font-weight-bold font-size-minus">Optando pelo pagamento por Boleto, a confirmação será realizada no dia útil seguinte ao pagamento.</p> -->
