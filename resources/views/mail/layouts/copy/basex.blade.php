...
<body class="bg-body" width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly;">
    ...
    <![endif]-->
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <img src="{{ asset('/images/brand/logo-horizontal.png') }}" width="130" height="50" alt="alt_text" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                    {{-- <img src="{{ $message->embed(public_path() . '/images/brand/logo-horizontal.png') }}" width="130" height="50" alt="alt_text" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;"> --}}
                </td>
            </tr>
            <!-- Email Header : END -->

            <!-- Full Bleed Background Section : BEGIN -->
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="bg-first">
                <tr>
                    <td>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="padding: 20px; text-align: center; font-family: sans-serif; font-size: 18px; line-height: 20px; color: #fff; font-weight: bold;">
                                        <p style="margin: 0;">@yield('title')</p>
                                    </td>
                                </tr>
                            </table>
                            <!--[if mso]>
	    ...
	    <!-- Full Bleed Background Section : BEGIN -->
	    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #9a1189;">
	        <tr>
	            <td>
	                <div align="center" style="max-width: 600px; margin: auto;" class="email-container">
	                    <!--[if mso]>
